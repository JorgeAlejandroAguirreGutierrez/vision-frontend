...
export const tab_equivalencia_medida='Equivalencia Medida';
...
export const item_equivalencia_medida='Equivalencia de Medidas';
...
export const ico_equivalencia_medida='fa fa-exchange';
