...
export class ReporteCajaService {
  ...
  moneda1: number, moneda050: number, moneda025: number, moneda010: number, moneda005: number, moneda001: number) {
    this.http.get(environment.host + urn.ruta + urn.reporteCaja + urn.pdf + urn.slash + apodo + urn.slash + fechaInicio + urn.slash + fechaFinal + urn.slash + empresaId
      ...
      + urn.slash + moneda1 + urn.slash + moneda050 + urn.slash + moneda025 + urn.slash + moneda010 + urn.slash + moneda010 + urn.slash + moneda005 + urn.slash + moneda001, optionsGenerarArchivo)
    .subscribe((blob: Blob) => {
  ...
  obtener(apodo: string, fechaInicio: string, fechaFinal: string, empresaId: number, 
    ...
    return this.http.get<Respuesta>(environment.host + urn.ruta + urn.reporteCaja + urn.pdf + urn.slash + apodo + urn.slash + fechaInicio + urn.slash + fechaFinal + urn.slash + empresaId
      + urn.slash + billete100 + urn.slash + billete50 + urn.slash + billete20 + urn.slash + billete10 + urn.slash + billete5 + urn.slash + billete2 + urn.slash + billete1
      + urn.slash + moneda1 + urn.slash + moneda050 + urn.slash + moneda025 + urn.slash + moneda010 + urn.slash + moneda010 + urn.slash + moneda005 + urn.slash + moneda001, options).pipe(
