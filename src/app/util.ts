...
export const vehiculo: string='/vehiculo';
...
export const estacion: string = '/puntoVenta';
...
export const facturaLinea: string = '/facturaLinea';
...
export const secuencial: string = '/secuencial';
